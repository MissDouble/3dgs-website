      ...
      <div id="heroCarousel" class="carousel slide h-100 position-relative">
        ...
        <transition name="fade-slide-up" appear>
          ...
          >
            ...
            <router-link to="/login" class="btn btn-primary btn-lg shadow" style="min-width: 160px;">
              建立模型
            </router-link>
            <router-link to="/download" class="btn btn-success btn-lg shadow" style="min-width: 160px;">
              下載 App
            </router-link>
            </div>
          </div>
